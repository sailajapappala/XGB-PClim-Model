...
### Step 1 — Open the XGB-PClim Project Folder
...
Open the `XGB-PClim` project folder.
...
Run the script or run all cells.
...
* `python XGB-PClim_predict.py` runs the prediction script
